    ...
    <div className="min-h-screen bg-[linear-gradient(180deg,#fcfcfb_0%,#f3f4f7_100%)] p-4">
      <div className="mx-auto flex min-h-[calc(100vh-2rem)] max-w-xl items-center">
        <section className="surface-panel w-full rounded-[2rem] border border-white/70 p-8">
          <AppMark
            icon={Building2}
            eyebrow="Reenviar confirmação"
            title="Trimio Studio"
            subtitle="Ativar conta admin."
            tone="admin"
            compact
          />
          <h1 className="mt-8 text-3xl font-semibold text-zinc-950">Reenviar email de confirmação</h1>
          <p className="mt-2 text-sm text-zinc-500">Se a conta existir e ainda não estiver confirmada, enviamos um novo email.</p>
