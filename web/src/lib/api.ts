...
export const superadminApi = {
  ...
  updateOwnerPassword: (token: string, id: string, data: { password: string }) =>
    api.patch(`/superadmin/barbershops/${id}/password`, data, { headers: { Authorization: `Bearer ${token}` } }).then((r) => r.data),
